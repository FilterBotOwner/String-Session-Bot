    ...
    try:
        if data == "start":
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton('ᴜᴩᴅᴀᴛᴇꜱ', url='https://telegram.me/ShinchanDubber'),
                     InlineKeyboardButton('ꜱᴜᴩᴩᴏʀᴛ', url='https://telegram.me/ShinchanDubberChat')],
            ...
            await query.message.edit_text(
                ...
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton('💥 ʀᴇᴘᴏ', url='https://youtu.be/kHeRAUEy-l8?si=5dop-k7AiyEUpU2n'),
